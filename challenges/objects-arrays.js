...
const trex = new Dino('tyrannosaurus', 'carnivorous', '7000kg', '12m', 'Late Cretaceous');
//console.log(hero1);
// const trex = new Dinosaur (tyrannosaurus, carnivorous, '7000', '12', 'Late Cretaceous');

let stego = new Dino('stegosaurus', 'herbivorous', '2000kg', '9m', 'Late Jurassic');

let velociraptor = new Dinosaur('velociraptor', 'carnivorous', '15m', '1.8m', "Late Cretaceous");
...
const lowCaseAnimalNames = zooAnimals.map(function(value) {
